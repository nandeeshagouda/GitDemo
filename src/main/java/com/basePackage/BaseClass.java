...
public class BaseClass {
	...
	public void setExtent() {
		...
		htmlReporter.config().setReportName("OrangeHRM Test Autmation Report");
		...
		extent.setSystemInfo("Test","Nandish");
	...
	@BeforeMethod
	public void setup() {
		System.setProperty("webdriver.chrome.driver","D:\\NANDISH\\chromedriver.exe");
